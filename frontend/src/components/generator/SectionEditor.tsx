...
export function SectionEditor({
  ...
  const handleOptimize = async () => {
    ...
    try {
      // Call backend API for section generation
      const response = await fetch('http://localhost:5001/api/generate-section', {
        method: 'POST',
        headers: {
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-center gap-4">
                  <div className="text-center">
                    ...
                    <div className="text-[10px] text-gray-500 uppercase tracking-wide">Selected</div>
                  </div>
                  <div className="text-center">
          ...
          <div className="mb-3">
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-2 right-2">
                <div className="px-1.5 py-0.5 bg-white rounded text-[10px] text-gray-500 shadow-sm">
