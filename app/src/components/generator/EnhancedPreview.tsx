        ...
        <div className="flex items-center justify-between">
          ...
          {showAtsIndicators && (
            <div className="flex items-center gap-4 text-xs">
              <div className="flex items-center gap-1">
                ...
                <span className="text-gray-600 font-medium">Keywords: {Math.round(analysis.keywordCoverage)}%</span>
              </div>
              <div className="flex items-center gap-1">
                <div className={`w-2 h-2 rounded-full ${
                ...
                <span className="text-gray-600 font-medium">ATS: {Math.round(atsScore)}%</span>
              </div>
              {missingKeywords.length > 0 && (
                <div className="flex items-center gap-1">
                  <AlertTriangle className="w-3 h-3 text-amber-500" />
                  <span className="text-amber-600 font-medium">{missingKeywords.length} missing</span>
                </div>
              )}
            </div>
          )}
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-1 text-foreground/60 hover:text-foreground/80 disabled:opacity-50"
            >
              <RefreshCw className="h-4 w-4" />
            </button>
            <button className="p-1 text-foreground/60 hover:text-foreground/80">
          ...
          <div className="p-8">
            ...
            <div className="max-w-2xl mx-auto bg-white border rounded-lg shadow-sm p-8">
              <div className="text-center mb-6">
                <h1 className="text-2xl font-bold text-foreground">HARSHA VIPPALA</h1>
              ...
              {resumeState?.summary?.current && (
                <div className="mb-6">
                  <h2 className="text-lg font-bold text-foreground mb-2 border-b">
                    PROFESSIONAL SUMMARY
                  </h2>
                  <div 
              ...
              {!resumeState?.summary?.current && !resumeState?.skills?.current && !resumeState?.experience?.current && (
                <div className="text-center py-12">
                  ...
                  <p className="text-foreground/60 font-normal">Start editing to see your resume preview</p>
                </div>
              )}
            </div>
          </div>
