...
// User information - configurable via environment variables
const USER_ID_STRING = process.env.USER_ID || 'f556989c-4903-47d6-8700-0afe3d4189e5'
const USER_ID = new TextEncoder().encode(USER_ID_STRING)
const USER_NAME = process.env.USER_EMAIL || 'harsha@resumeforge'
const USER_DISPLAY_NAME = process.env.USER_FULL_NAME || 'Harsha'
