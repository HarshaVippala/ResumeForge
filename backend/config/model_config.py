...
# Recommended model for resume tasks - DeepSeek R1
RECOMMENDED_MODEL = "deepseek/deepseek-r1-0528-qwen3-8b"
...
MODEL_CONFIGS = {
    ...
    "keyword_extraction": {
        ...
        "max_tokens": 1500,
        "temperature": 0.2,  # Lower for more consistent extraction with DeepSeek
        "description": "DeepSeek optimized for structured keyword extraction and categorization"
    },
    
    "section_generation": {
        "model": "deepseek/deepseek-r1-0528-qwen3-8b", 
        "max_tokens": 1200,  # Increased for better content generation
        "temperature": 0.3,  # Lower for DeepSeek's stronger reasoning
        "description": "DeepSeek balanced reasoning and creativity for resume sections"
    },
    
    "experience_bullets": {
        "model": "deepseek/deepseek-r1-0528-qwen3-8b",
        "max_tokens": 1000,
        "temperature": 0.3,  # Consistent with DeepSeek's capabilities
        "description": "DeepSeek optimized for generating varied experience bullets"
    }
}
